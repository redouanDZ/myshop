...
module.exports = {
  ...
  PORT: Number(process.env.PORT) || 3000,
    JWT_SECRET: process.env.JWT_SECRET || (process.env.NODE_ENV === 'production' ? '' : 'development_jwt_secret_change_me'),
    COOKIE_SECRET: process.env.COOKIE_SECRET || (process.env.NODE_ENV === 'production' ? '' : 'development_cookie_secret_change_me'),
